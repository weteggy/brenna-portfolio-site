...
function getCustomizedContent(responses) {
  ...
  const headline = isEvaluator && wantsCraft
    ? "Strategic Narrative as Design Craft"
  ...
  const projectOrder = wantsCraft
    ...
    : wantsStrategy
    ? ["strategize", "design", "diagnose", "build"]
    : wantsAI
    ? ["build", "strategize", "diagnose", "design"]
    : wantsLeadership
    ? ["build", "design", "strategize", "diagnose"]
    : ["diagnose", "strategize", "build", "design"];

  // ── Curated capabilities (3 most relevant) ──
  const allCapabilities = [
    { icon: "palette", title: "Design Language & Brand", desc: "Tiered token architecture, OKLCH color systems, design language development, multi-product theming, visual identity" },
    ...
    { icon: "brush", title: "Visual Design Craft", desc: "Strategic narrative, presentation design, brand systems, editorial design, product marketing, motion and video" },
  ];
...
const PROJECTS = {
  diagnose: {
    title: "Diagnosing and Resolving a Four-Year Design System Stall",
    description:
      "NielsenIQ's design system had been stalled for four years. While still a UX designer, I diagnosed why by connecting user complaints, rising convergence costs, and missing infrastructure into a single argument leadership hadn't heard before. I built the token architecture nobody knew was missing, got design system work prioritized in PI planning for the first time since our rebrand four years prior, and earned the lead title by doing the job before I had it.",
    tags: ["Systemic Diagnosis", "Token Architecture", "Stakeholder Influence", "Change Management"],
    leadershipAngle:
      "Earned the lead title by doing the job before I had it. Built credibility through one-on-one stakeholder conversations, never once pitching 'design tokens' to leadership, instead I led with their problems.",
    craftAngle:
      "Built a tiered token architecture covering color, typography, spacing, elevation, radius, and motion — the first shared design language across the portfolio.",
    outcomesAngle:
      "First design system work prioritized in PI planning since the rebrand 4 years ago. UX Designer → Global Design System Lead in a matter of months. Six token categories shipped. CPO pipeline established.",
  },
  strategize: {
    title: "From Product Org Denial to CPO Approval in Just One Quarter",
    description:
      "After rebuilding the foundational tokens, I hit a harder wall: one product's engineering team controlled the design system roadmap for every product. When PI planning denied capacity, I stopped trying to win within the structure and built around it. I partnered with a product team that had capacity, designed a framework-agnostic spec-driven architecture using AI as the build engine, connected the work to the company's AI-readiness gap, and navigated the argument through our VP to the CPO.",
    ...
    outcomesAngle:
      "First CPO meeting on the design system. Dedicated engineering resources. V2 project greenlit. Cross-functional contributors assembled.",
  },
  build: {
    title: "40+ Deliverables in 10 Weeks, All Built With AI",
    description:
  ...
  design: {
    title: "Connecting design, communication, and marketing - adapting the story and knowing which lever to pull",
    description:
      "Four decks, four audiences, four registers. A senior leadership conference deck where I leaned into video and animation to make AI vision feel exciting. An AI and innovation peer presentation that came out of a strategy workshop I helped facilitate, focused on where NIQ fits in the ecosystem. A product marketing deck I owned end-to-end, articulating why NIQ is essential for our consumers and the industry. And a UX team education deck where I set visual design aside in favor of metaphor and writing. The practice underneath all four is the same.",
    tags: ["Visual Design", "Brand Systems", "Editorial Design", "Strategic Narrative", "Product Marketing", "Presentation Design"],
    leadershipAngle:
      "Helped facilitate the AI builder strategy workshop that produced two of these decks, and owned the AI narrative product marketing deck end-to-end. Knew when to lead with design, when to lead with positioning, and when to lead with metaphor.",
    craftAngle:
      "Range from production-level visual craft — video and animation for the senior leadership conference — to deliberate restraint in the handoff deck, where the craft choice was metaphor over visuals. The skill is matching the craft to the room.",
    outcomesAngle:
      "The senior leadership conference deck was NIQ's first AI-vision exec moment and unlocked the follow-on collaborations that defined the year. The workshop produced two artifacts that scaled from there: a peer-facing AI and innovation deck and the AI narrative product marketing tool.",
  },
};
      ...
      sections: [
        {
          ...
          hideImage: true,
          body: "When I joined NielsenIQ the design system was a thorn in everyone's sides, including the designers'. \n\nA library did exist in Figma with a shared code repository, but it functioned more like a collection of components to use if they suited you and ignore if they didn't, rather than a system. Foundational styles existed only in Figma and were tied to individual components rather than organized by intent, which meant there was no shared design language connecting what a designer meant by 'primary surface background' and what an engineer typed into code. Every product team translated on their own, and every translation introduced drift.\n\nUsers complaints about usability, visual inconsistency, and disjointed aesthetics came in across every client-facing product. The same action might use different colors, different spacing, and different interaction patterns depending on which product you were in, and sometimes even in two different pages of the same product. These weren't edge cases, they were the everyday experience and leadership saw these as product-level problems to fix product by product or even feature by feature with nobody connecting the complaints to a systemic cause.\n\nAs the company was converging its flagship product with a newly acquired platform, a strategic priority with executive sponsorship and a real timeline, designers could feel the stakes rising. This convergence project would require two product experiences, built by different teams with different conventions and different systems, to feel like one product. Without a shared design language, it would mean rebuilding every interface manually or accepting that the 'unified' platform would feel stitched together.\n\nAs a part of this convergence, a design system lead had been brought in to help drive adoption to support the convergence work. When his contract ended it became clear to UX leadership that in the time he'd been here, adoption hadn't moved forward and the flagship product was more out of sync than ever. By early-2025, the default assumption was that design systems were in fact not bringing value to the product and were instead limiting velocity.\n\nBut as anyone who has spent time in design systems knows, this uphill battle is par for the course. So I decided to stop hoping leadership would see the light and instead make the light so bright it was impossible to ignore."
        },
        {
          ...
          body: "I started doing diagnostic work in early 2025, months before I had the design system lead title, while I was just an IC. What I found wasn't just a technical gap, it was a perception problem with three reinforcing causes. \n\nFirst, nobody was connecting user complaints to a root cause. Product teams were hearing feedback about usability issues and visual inconsistency, and they were treating each complaint as a product-level problem. They were fixing screens, adjusting flows, and redesigning features but nobody had stepped back and tried to see if these complaints were symptoms of a more structural problem. The individual fixes were reasonable if you assumed each problem was local, but they were expensive and futile if you recognized the problems were structural. \n\nSecond, the design system had no advocate who could make the value legible outside UX. Tokens, semantic layers, component APIs were concepts that didn't translate into language a VP of Product or a CPO acts on. The previous lead had been hired to drive adoption, but adoption of what? A component library with no token system, no governance, no connection to the problems leadership cared about? The work had stalled because nobody was building the bridge between what a design system is and what it solves in terms that mattered to the people who controlled investment. \n\nThird, institutional cynicism was the default. I wasn't just proposing a foundational project, I was proposing that a category of work the org had written off was actually the answer to problems they were actively spending money trying to solve in other ways. \n\nThe critical reframe came from mapping user complaints, product convergence costs, and the missing infrastructure together. The product org already knew that the convergence of two products would be complex and expensive, and that users were unhappy with both products. What hadn't been connected for leadership yet was that both problems had the same root cause, no shared design language. I knew that a design system with a proper foundation was the fix they didn't yet know they needed.",
        },
        {
          heading: "Earning credibility before having authority",
          imageSrc: "/FoundationsRoadmap.png",
          imageAlt: "Foundations project roadmap",
          body: "In early 2025, I began having direct conversations with the product leaders who controlled prioritization. These one-on-one conversations gave me the opportunity to understand what each stakeholder cared about and connect the foundations work to those specific concerns. \n\nProposing a nearly year long foundational project to an organization that had failed to deliver one for four years required a different kind of credibility than a good project brief. I needed people to have already seen me do the work and to trust that I understood their constraints before I asked them to prioritize it. \n\nI never pitched 'design tokens' to leadership, I didn't even lead with 'design system', instead I led with their problems: users unhappy with inconsistency, convergence costs ballooning without shared infrastructure, teams duplicating effort across the portfolio. The design system wasn't a UX initiative competing for budget, but rather it was the infrastructure that would make their existing investments actually work.",
        },
        {
          heading: "Building the token system",
          widget: "tokenExplorer",
          body: "The biggest technical challenge wasn't building the token system, it was changing how the entire design team thought about design decisions. \n\nThe Figma library had color styles, but they were flat and tied to specific components rather than organized by intent. Individual components had individuall assigned colors, there was no layer of abstraction that said 'this button and this card both use color.action.primary because they serve the same semantic purpose.' Designers picked colors from a component-level swatch and the concept of why a color was being used, rather than which color it was, didn't exist as a shared mental model. \n\nI introduced a tiered architecture: primitive tokens to define the base palette and semantic tokens to define intent. The primitive layer gives you the 'what' while the semantic layer gives you the 'why'. \n\nGetting alignment took months, with our team I ran iterative working sessions, built documentation with concrete examples from our actual components, and spent one-on-one time with designers who were struggling with the shift. The practical demonstration in Figma is what sold it for our designers, when we changed a semantic token, every component that references it updated automatically. This was compared to when a hardcoded value changes, someone has to find and update every instance manually. That difference, shown in real time, made the abstract concrete. \n\nThe cross-disciplinary work was equally important. Figma's variable system and how engineers consume tokens in code are fundamentally different mental models. The naming conventions had to work in both contexts so that a designer reading a Figma variable and an engineer reading a stylesheet could see the same name and understand the same intent without a translation layer. I worked across both disciplines to negotiate conventions that both teams could work with consistently. \n\nKey architecture decisions: \n\nColor — ten level primitive scale based on a core value rather than dozens of hand-picked shades. Sub-brand theming works by overriding primitive values so the entire semantic layer can recalculate. I chose scalability over artisanal color craft because the multi-product portfolio made theming a structural requirement. \n\nTypography — organized by role rather than size. A typeface change becomes a single-token update per role, not a hunt through every component. \n\nSpacing — 4px base unit with semantic application tokens encoding which multiples to use where, removing the decision from individual designers. \n\nElevation, radius, motion — invested in these because they're what makes a multi-product platform feel like one product rather than a collection of products wearing the same color palette.",
        },
        {
          heading: "Raising the priority",
          hideImage: true,
          body: "The stakeholder work and the foundations project converged into two outcomes that changed the trajectory of the design system entirely. \n\nFirst, I got the design system prioritized in PI planning for the first time since our rebrand, nearly four years prior. That doesn't sound dramatic on paper, but it meant the design system went from not being part of the planning conversation at all to having a seat at the table where capacity decisions were made. The foundations work created the evidence and the relationships that made it possible to argue, credibly, that design system capacity needed to be planned alongside product delivery — not because the UX team wanted it, but because the org's strategic priorities required it. \n\nSecond, our UX Director, who had seen me doing this work for months, recommended me for the design system lead role when the outgoing lead's contract ended. In November of 2025, I was officially promoted. By that point, I had already moved the work further in a matter of months than it had moved in the previous three and a half years."
        },
        {
          heading: "Reflection",
          hideImage: true,
          body: "The hardest part of this undertaking wasn't the token architecture, it was getting an organization to see that a design system — something they'd never valued — was the answer to problems they were already spending time and money trying to solve. \n\nThe only way I found to do this was to stop talking about the design system entirely and start talking about the problems teams were facing. 'We need design tokens' is a statement about the design system, but 'users are unhappy and convergence will cost twice as much as it should because we don't have shared design infrastructure' is a statement about problems leadership already owns. The underlying work is the same but it had completely different receptivity. \n\nThe other lesson I learned from this project was that introducing a new mental model can take longer than building the system it describes. The Figma variable work was the smaller effort, whereas getting designers to think in intent rather than component-level styles, and getting engineers to see tokens as a shared contract rather than a design team concern, took months of sustained conversation. A token system that nobody internalizes is just a more organized version of the same chaos. \n\nUltimately I did the job I wanted, not the job I had. I saw gaps nobody was addressing, took the first steps to close them, and made the work visible enough that the organization recognized it needed an engaged leader to keep going. And that diagnosis, the understanding of what was broken and why, is what earned me the title of global design system lead.",
        },
      ],
    },
  },
      ...
      sections: [
        {
          heading: "Strategic context",
          hideImage: true,
          body: "After successfully rebuilding and prioritizing a new foundational token system for the design system, the uphill battle of design system priority continued. I quickly found that having a seat at the planning table was revealing a harder truth: the organizational structure made it nearly impossible for the design system to actually get the capacity it needed. \n\nThe CUIC team — the engineering group responsible for building shared components — reports into Discover, the flagship product. That reporting structure means one product controls the design system roadmap for every product. When Discover needs bug fixes, the design system waits. When Discover needs customization cleanup, the design system waits. This isn't a failure of intent, everyone agreed the design system was critical, but the organizational structure made the outcome inevitable. \n\nWith the lead title in hand and a token architecture ready for implementation, I now had a different problem: how do you serve an entire product portfolio when the only build capacity is controlled by one team that can't prioritize you?",
        },
        {
          heading: "The PI planning problem",
          hideImage: true,
          body: "My original roadmap was clean: create tokens in code (PI4 2025, done), raise bugs and customizations in Discover (PI1 2026), apply tokens to the common component library and publish V1.0.0 (PI2 2026). \n\nThen PI2 planning happened. \n\nThe bug-fix capacity that was supposed to go to feature teams was allocated entirely to CUIC. They could only complete bug fixes and customization removal for half of the components. The CUIC team escalated and requested reprioritization and while product leadership acknowledged the work was critical, they still denied the request. The remaining work pushed to PI3, meaning tokens wouldn't be available in the common code repository until September 2026 at the earliest. \n\nI documented the decision and its downstream impact in a communication to stakeholders not as a complaint, but as a risk assessment. The consequences were concrete: product teams outside Discover couldn't consume the standard component library until September. Without access to the official library, teams would customize and override components to keep up with their own delivery timelines, reintroducing the exact inconsistencies the design system was created to eliminate. The pattern we'd worked so hard to break in Discover would replicate across the portfolio. \n\nI raised three questions for leadership: whether we needed interim guardrails for other product teams, whether PI3 capacity could be revisited, and whether the org needed a longer-term conversation about how cross-product infrastructure gets prioritized. \n\nThe response was acknowledgment without action, leadership agreed with the assessment but didn't change the prioritization. \n\nThis confirmed what I'd been suspecting, that waiting for the existing structure to prioritize the design system was not a viable strategy and I'd need an entirely different approach.",
        },
        {
          heading: "Solving the multi-product problem",
          widget: "projectBoard",
          body: "The structural constraint was clear, one product controlled capacity for every product's design system needs. But I'd also been building relationships across the product org for months, and I could see resources that weren't visible from inside the CUIC bottleneck. \n\nAnother product team, MEFF, had frontend developers with available capacity and a PM willing to invest in shared infrastructure. They needed the design system as much as anyone, as their product had been built rapidly with AI and was functional but not componentized. They had motivation, capacity, and a concrete problem the design system could solve. \n\nI took advantage of this opportunity and designed a parallel path: while we continued to fight for capacity within CUIC's constrained roadmap, I proposed building a version 2.0.0 of the design system, leveraging AI tools to build a framework-agnostic spec-driven design system. The MEFF team's developers would be the build engine, using AI-assisted development to handle the mechanical restyling while focusing their judgment on review, edge cases, and integration. \n\nThis wasn't just a workaround for CUIC's capacity problem, but a fundamentally different model for how shared infrastructure could get built: cross-team collaboration where multiple products contribute capacity to a shared outcome, rather than one team owning everything and every other team waiting. \n\nI made sure to bring in the CUIC tech lead as an architecture advisor. His involvement meant the CUIC team's technical participation would be built into the library they would eventually be upgrading to when the time came. This was a strategic way to strengthen the relationships of not just UX but also tech as a design system team that served products across the organization.",
        },
        {
          heading: "Thinking long term: Parallel solutioning as an organizational model",
          hideImage: true,
          body: "The V2 project wasn't just about delivering components faster, it was a proof of concept for a fundamentally different way of resourcing shared infrastructure at NIQ. \n\nThe CUIC bottleneck wasn't a temporary problem, as long as the shared component library lived inside one product's org, it would always be subordinate to that product's needs. No amount of advocacy within that structure would change the timeline. The V2 approach demonstrated an alternative: what happens when multiple teams contribute capacity to shared infrastructure, coordinated by a design system lead who works across organizational boundaries. \n\nIf V2 succeeded, it would create a concrete argument for changing how the org invests in shared infrastructure, not through restructuring (which is slow and political), but by demonstrating that cross-team collaboration on infrastructure produces results that single-team ownership can't. \n\nI designed the project plan with this larger argument in mind. The sprint structure, the role allocations, the stakeholder update cadence, the release valves were all documented with enough rigor to be replicated. This wasn't a one-time workaround, it was a model, and one that could scale in a new AI-driven landscape.",
        },
        {
          heading: "Getting the CPO meeting",
          imageSrc: "/CPO ppt.gif",
          imageAlt: "CPO presentation deck",
          body: "Getting the design system in front of the CPO was, by itself, a milestone. In four years, the CPO had never had direct visibility into the design system — what it was, what state it was in, or why it mattered beyond the UX team. \n\nGoing to a CPO with a two-part thesis, that the org is falling behind on AI and the design system is the key to catching up, proposed by a design lead he'd only worked with minimally, was a low-percentage play. Instead I started with our VP of Product and UX, she had the organizational context, the strategic awareness, and the CPO's ear. More importantly, she was already feeling the tension between velocity expectations on her teams and the lack of a powerful foundational layer to power the AI tools. \n\nI connected two things she was already worried about. First: the industry was moving toward AI-assisted development and NIQ was being left behind. Second: even when the org did move on AI, the design system wasn't ready to support it. AI tools generate output based on what they can consume, and our system couldn't be consumed by AI. \n\nWhat I didn't anticipate was that the VP didn't just set up a meeting, she started using the AI-readiness framing in her own conversations with leadership. By the time I got into the CPO's office, the idea that NIQ was falling behind on AI and that the design system had a role in catching up wasn't entirely new to him. \n\nI framed the CPO conversation around two connected questions: Is the org moving fast enough on AI to stay competitive? And when we do move — what does AI need from us to actually work? \n\nI showed what a well-structured design system looks like from an AI tool's perspective: tokenized components with documented APIs, semantic metadata that describes intent. Then I showed where NIQ actually was: hardcoded values, undocumented components, no semantic layer. Even if we unlocked AI tools tomorrow, they'd have nothing structured to build on. The productivity gains everyone expected from AI would be eaten by manual cleanup. \n\nThe CPO didn't just acknowledge the point, he gave explicit approval and enthusiasm for the MEFF team to move forward with the V2 project. A CPO greenlighting dedicated resources for a design system that a UX lead proposed was a first.",
        },
        {
          heading: "Adapting the message for every room",
          hideImage: true,
          body: "The AI framing wasn't universally effective, while it landed with leadership because it connected to competitive anxiety it bounced off the engineering teams who would actually build on the system. \n\nWhen I used the AI-readiness argument with frontend engineers, the response was skepticism. Their experience with AI coding tools was that the tools were useful for boilerplate but unreliable for design fidelity. Telling them 'we're building the design system for AI consumption' sounded like solving a problem they didn't believe existed yet, especially since we currently had an entire common component library in code. \n\nSo I adjusted, with engineering audiences I stopped leading with AI entirely. I talked about the same architectural decisions, like tokens as CSS custom properties, documented component APIs, and semantic naming, but framed them as good engineering practice that happened to also make the system AI-consumable. The AI story was for leadership but for the engineers the story was about code excellence. Both were true but knowing which one to lead with is the skill I really developed through this work. \n\nI carried the same adaptive approach into product planning. I stopped framing design system capacity as a request and started framing it as a dependency of a transition that was going to happen whether the org prepared for it or not. 'We need two sprints of design system work' is a request that competes with feature delivery but 'When we unlock AI tools — and we will have to — the design system is what determines whether that transition produces velocity or chaos' changes the conversation entirely.",
        },
        {
          heading: "Reflection",
          hideImage: true,
          body: "The most valuable thing I learned from this process was that making visible a problem the organization couldn't see and getting buy in is really about communication and storytelling. \n\nSeeing two differnt gaps that could be solved with one solution was ultimately an exercise in framing. The AI gap was one aspect, an essential need and an external pressure with leadership, and the design system gap was a different aspect, centralized in the day to day work of UX and tech teams. The real win was connecting them and developing the right story to tell to the right audience. I saw that the same infrastructure solved both problems, and I built an argument that made that connection legible to each different person who could help me act on it. \n\nThe PI planning experience taught me something equally important: there's a difference between getting a seat at the table and getting what you need from the table. PI planning gave the design system visibility, but it didn't give it capacity. The structural constraint of one product controlling shared infrastructure, was too deep for planning processes to override. That's when I stopped trying to win within the existing structure and started designing around it. \n\nThe lesson I'd go back and tell myself: Find the strategic pressure your stakeholders are already feeling and show them how your solution relieves it. The design system became the answer to a question leadership was starting to ask — 'how do we catch up on AI?' — rather than an initiative competing for attention. \n\nAnd when factors beyond your control are blocking essential work, getting creative and building cross-functional partnerships can help leverage an even stronger solution than would've been available through the traditional path.",
        },
      ],
    },
  },
      ...
      sections: [
        {
          heading: "Strategic context",
          hideImage: true,
          body: "I'd already diagnosed a four-year-old systemic problem and rebuilt the token architecture. I'd also navigated PI planning, designed around the structural bottleneck, framed the AI argument, and secured the CPO's approval and dedicated engineering resources. \n\nNow I had to prove all of it worked. And more than that, I had to prove that I personally understood AI well enough to lead this work, not just advocate for it. \n\nThis is about what I built with my own hands, what I built with a team, and why both matter for where design systems are going.",
        },
        {
          heading: "Using Claude for deep research",
          body: "Before the V2 build started, I needed to understand something nobody at NIQ had investigated: how do AI tools actually interact with design systems? Not the marketing pitch, but the nitty-gritty reality. \n\I used Claude as a deep research tool, not for code generation (at least not yet) but for structured inquiry. I explored how LLMs consume component documentation, what makes a token system machine-readable versus just human-readable, how AI code generation tools handle styling when they have structured specs versus when they don't, and what the difference looks like in actual output. \n\nWhat I found was consistent across every tool I tested: when a codebase has well-structured component APIs with clear documentation and semantic tokens, AI tools generate code that uses existing components correctly. When documentation is sparse or absent, the tools invent their own implementations. These may be technically functional but are visually inconsistent and disconnected from whatever design standards exist. The pattern was clear: AI tools are only as good as the structured input they can consume. \n\nThis research helped to directly shape the V2 architecture decisions. Things like why CSS custom properties matter (they're readable by any tool), why semantic naming conventions matter (they encode intent, not just appearance), why component API documentation matters (it's the spec AI builds against), and why we needed to think about AI metadata as a first-class concern rather than an afterthought. \n\nThe research also gave me the language for all of the conversations I'd need to have about this. When I showed side-by-side examples of what AI produces with structured design system input versus without it, I wasn't presenting theory. I was presenting findings from real experimentation.",
        },
        {
          heading: "Uncovering how to adapt a design system for an AI-enabled future",
          hideImage: true,
          body: "The deeper I went, the clearer the thesis became: a design system isn't just a component library for humans anymore, it's a structured data layer that AI tools consume to generate consistent product UI. And the design systems that are built with that dual audience in mind — human developers and AI tools — are the ones that will define how products get built in the next era. \n\nThis isn't a small reframe, it changes what a design system needs to contain. Traditional design systems need components, tokens, and documentation. AI-ready design systems also need semantic metadata describing component intent, explicit composition rules, machine-readable specs that define props, variants, and valid combinations, and guidance that distinguishes what AI handles well from what requires human judgment. \n\nI built this understanding through a combination of Claude-assisted research, hands-on experimentation with AI code generation tools like Claude Code, Cursor, and Antigravity, and real-time observation of AI building our system during the V2 project. Myself and my design system teammate documented what happened as developers used Claude to restyle components: which prompts worked, where the AI hallucinated, which component patterns it handled well versus poorly. The AI consumption guide we're producing is built from empirical observation during a real production build not theoretical speculation. \n\nThis body of research is what I'll bring to every executive conversation, every PI planning session, and every architecture decision as a tangible result of this project. It's the foundation of NIQ's AI strategy for the design system and it came from my own initiative. I saw that the industry was moving and the org wasn't keeping up, and I went deep on my own time to build the understanding that the org needed.",
        },
        {
      ...
      sections: [
        {
          heading: "Strategic context",
          hideImage: true,
          body: "Design leadership at this level isn't separate from communication, and communication isn't separate from marketing. The work I'm known for at NIQ is the infrastructure — tokens, components, system architecture, AI-readiness, and AI-assisted building. But infrastructure on its own doesn't move an organization, what does is a story, told to the right room, in the register the room expects, with the craft choices that earn credibility before the prose has to. \n\nThe four decks here aren't variations on a single template. They're four very different artifacts produced for four very different rooms. One leaned hard on visual design and animation because the audience needed to feel excitement before they'd commit to vision. One came out of a workshop I helped facilitate and was a way for peers to align on where we fit in a fast-moving ecosystem. One is a product marketing tool, owned and managed by me, that articulates why NIQ is essential for our consumers and the industry as a whole. And one is purely educational, designed for the UX team, where I deliberately set visual design aside and led with metaphor because the audience needed clarity more than they needed polish. \n\nThe pattern that connects them is the same pattern that connects the rest of my work. When the design system advanced, it advanced because I'd designed an argument that someone outside design could act on. The token system was useful because of the audit and the explanation that came with it. The V2 project was approved because of the story I built for the CPO. Every consequential moment was a communication moment, and the craft of those stories — knowing when to lead with design, when to lead with positioning, and when to lead with metaphor — is the practice this case study captures.",
        },
        {
          heading: "Senior leadership meeting - AI vision and roadmap",
          images: [
            {src: "/slm1.gif", label: "SLM sonar intro"},
            {src: "/slm2.gif", label: "SLM data visualization"},
            {src: "/slm3.gif", label: "SLM AI roadmap"},
          ],
          body: "The senior leadership meeting (SLM) presentation was my first deck for an executive audience at NIQ. The brief was to get leaders excited about the future of AI, not to ask for a decision, not to present a roadmap defense, but to land a vision that would shape how leadership thought about the company's direction. That's a marketing problem more than an information problem. Excitement isn't generated by data; it's generated by the experience of the deck itself. \n\nI leaned hard into the design. This was the deck where I did the most intense visual work of the year — video production, animation, and motion design that gave our AI vision a powerful look and feel. The animation wasn't decorative, it was load-bearing. When you're trying to give a room a sense of what's coming, the visual language has to do work the prose can't do. A static slide that says 'AI will reshape how we deliver insights' reads as a claim. The same idea expressed through motion and sequence by showing the shift and letting the audience feel the velocity, reads as inevitable. That's the design problem, and it's why I invested in production-level craft for an internal audience that would have accepted much less. \n\nThis was also the deck that opened the door to everything else. It was one of the first AI-vision presentation for execs at NIQ, and it directly led to the follow-on collaborations and work requests that defined much of my future work and collaborations. Once leadership had seen that I could produce work at this caliber on a strategic topic, the assumption shifted. AI strategy stopped being a topic that happened in product and engineering rooms with design as a downstream consumer, and started being a topic where design had a seat at the table from the start. The deck wasn't just communication, it was positioning.",
        },
        {
          heading: "AI and innovation - peer presentation following a design sprint",
          images: [
            {src: "/ai innovation 1.png", label: "AI and Innovation title slide"},
            {src: "/ai innovation 2.png", label: "AI and Innovation introduction"},
            {src: "/ai innovation 3.png", label: "AI and Innovation agentic commerce"},
          ],
          body: "The AI and innovation presentation came out of an AI builder strategy design sprint I helped facilitate in early 2026. The workshop brought together cross-functional leaders to think through what an AI-builder strategy at NIQ should actually look like both internally and externallt. The follow-up presentation was an immediate translation of the workshop's output into something the peer audience could engage with. It was a clear picture of where NIQ fits in the AI ecosystem and why we are an essential piece of that system. \n\nThe audience here was peers, not executives. That changes the register completely as peers don't need to be sold; they need to be aligned. The deck wasn't trying to manufacture excitement or unlock a decision, it was trying to give a group of people a shared mental model of the ecosystem and our position inside it, so that downstream conversations could be aligned against a common backdrop. The visual design supports that goal with this deck being tighter, more analytical, less performative. The point isn't to feel the future, the point is to see it clearly. \n\nThe workshop facilitation work matters too. Producing the deck wasn't a translation exercise from someone else's strategy session. I was in the room helping shape the thinking the deck would later carry. That double-loop of facilitating the workshop, then designing the artifact that distributed the workshop's outcome to a wider audience, is a kind of work that doesn't happen unless someone is comfortable moving between strategy and storytelling without changing modes. That's the part I find genuinely satisfying about this practice.",
        },
        {
          heading: "AI narrative - product marketing for the industry",
          images: [
            {src: "/ai narrative 1.png", label: "AI Narrative title slide"},
            {src: "/ai narrative 2.png", label: "AI Narrative context setting"},
            {src: "/ai narrative 3.png", label: "AI Narrative compounding gaps"},
            {src: "/ai narrative 4.png", label: "AI Narrative enablement map"},
            {src: "/ai narrative 5.png", label: "AI Narrative enablement example"},
          ],
          body: "The AI narrative deck is the most recent and the most strategic of the four. It was also produced as a result of the AI builder strategy workshop, but it's a fundamentally different artifact than the peer presentation. This one is a product marketing tool, it's a document that articulates why NIQ is essential for our consumers and for the industry as a whole. It expresses what we uniquely understand, what we uniquely produce, and why an AI-driven future of measurement and insight needs us in it. \n\nI owned and managed the execution of this deck. That meant translating the strategy work, figuring out how we're actually telling the story visually and the structural work of how that story is sequenced across slides. It also meant the editorial discipline of resisting the version of this deck that was easier to make. The easier version is a deck that lists capabilities, names competitors, and asserts differentiation. The harder version, and the one I built, is a deck that constructs an argument an outside reader could be persuaded by, with positioning that earns its claims and a visual identity that reads as confident rather than promotional. \n\nThe visual register on this one is closer to editorial publishing than to a typical corporate marketing deck. Restrained palette, deliberate typographic hierarchy, a data treatment that earns trust by looking patient rather than urgent. Product marketing reads as credible when the visual choices look like they were made deliberately, and reads as hollow when they look like they were made on autopilot. Owning this deck meant I could enforce that level of intention all the way through, and that's the part of the work I'm most proud of.",
        },
        {
          heading: "Design handoff - education through metaphor",
          images: [
            {src: "/handoff 1.png", label: "Design handoff title slide"},
            {src: "/handoff 2.png", label: "Think of it this way, in every video game there are two crucial elements to actually playing the game. "},
            {src: "/handoff 3.png", label: "First, there are the mechanics and rules. Things like what button to press to execute actions like jumping, climbing, or punching; how much health you have and what can take that away; or what items you can carry with you along your journey and how to access them. These are our standards. The non-negotiable, predictable, and consistent foundations of our designs."},
            {src: "/handoff 4.png", label: "The other crucial element to any video game, is your Quest. In Super Mario Brothers it's to save Princess Peach, in Zelda it's to protect Hyrule. Even in something as simple as Tetris, the quest is to prevent your blocks from overflowing. Every game has a quest which helps the player make decisions in their game play. These are our principles. They don't dictate every move, but they give meaning to the decisions we make."},
            {src: "/handoff 5.png", label: "Principles tell you why you’re playing, Standards tell you how to play. Without principles, the game has no meaning; without standards, the game is unplayable. This is the idea I want us to take with us into our designs when we're making sure they are hand off ready."},
          ],
          body: "The handoff deck is a contrast to the rest of these examples. The audience for this presentation was the internal UX team, delivered as a part of our educational series. The point of the deck isn't to get a decision or to land a vision, it's to teach. And for this particular audience, with this particular content, I made a deliberate choice to forego the kind of design treatment I'd put into the other three decks and lead with communication instead. \n\nThe choice that drove the deck is metaphor. Design principles, in the abstract, are easy to nod along to and easy to forget. Anchored in a metaphor — a shared concrete picture that names what design principles do for a handoff — they become memorable in a way no checklist can match. I worked heavily with metaphor to express the value of design principles as a way to strengthen our team's handoff and avoid incorrect implementation. The metaphor reframes design principles from a compliance overhead to an actual force multiplier, and once that reframing lands, the rest of the content lands too. The deck holds together because the metaphor is doing the structural work that visuals usually do. \n\nThis was the deck that taught me how to design with restraint and communicate with intention. I could have created another animated, video-rich, visually intense piece and the team would have enjoyed looking at it, but likely missed the essential messaging. What the team needed was a clear mental model they could carry into their next handoff conversation. Picking a metaphor, the right one, the one that fits the team's actual experience — and letting the writing carry the deck was a craft choice. It's the same kind of judgment as selecting which states a component needs. You match the treatment to the job.",
        },
        {          
          heading: "Knowing which lever to pull",
          hideImage: true,
          body: "Looking at the four decks together, the variable that changes is which discipline carries the work, not the underlying practice. The senior leadership conference deck is carried by visual design, motion, and production craft. The AI and innovation peer presentation is carried by clear positioning and ecosystem framing. The AI narrative deck is carried by product marketing strategy and editorial discipline. The handoff deck is carried by metaphor and writing, with visual design intentionally pulled back. Four decks, four very different decisions about which lever to pull. \n\nWhat stays constant is the underlying judgment. Strategic narrative, figuring out what story the room is ready to hear and which version of the truth lands. Audience modeling, knowing the difference between an audience that needs to be sold, aligned, marketed to, or taught. Visual decision-making, knowing when to push craft to the front and when to pull it back so the message can carry. And ownership, being willing to take responsibility for the strategic content of the deck, not just its execution. That last piece is what made the AI narrative deck what it became, and it's the piece that matters most for the kind of work I want to do next. \n\nThe practice is one practice for me, not four. The systems work I'm known for at NIQ is what shows up on a job description. The way I make the case for those systems across rooms, in registers, with deck formats doing genuinely different jobs, is what made the system work possible.",
        },
        {
          heading: "Reflection",
          hideImage: true,
          body: "For the role I'm moving toward, this is the part of the portfolio that signals the bridge. Design systems leadership and brand-leaning strategic communication aren't separate practices for me. They're the same instinct applied to different artifacts. \n\nThe lesson I'm carrying forward is that the most senior version of this work isn't being the best designer in the room or the best communicator in the room. It's knowing, for a given audience and a given moment, which discipline should carry the weight, and being capable enough across all of them to make that call without compromise. The senior leadership deck didn't need restraint, so I gave it everything. The handoff deck didn't need polish, so I gave it metaphor. The AI narrative deck needed ownership of the strategic content, so I built it that way. Reading the room, choosing the lever, and executing — that's the practice this case study is really about.",
        },
      ],
    },
  },
...
function TokenExplorer() {
  ...
  const afterTypography = [
    ...
    { role: "DataViz", sizes: [{ name: "2xl", token: "dataviz-2xlarge", example: "36px / mono" }, { name: "xl", token: "dataviz-xlarge", example: "28px / mono" }, { name: "large", token: "dataviz-large", example: "24px / mono" }, { name: "medium", token: "dataviz-medium", example: "16px / mono" }, { name: "small", token: "dataviz-small", example: "12px / mono" }] },
  ];
                  ...
                  {!section.hideImage && !section.widget && (
                    section.embed ? (
                      ...
                      <div style={{ margin: "24px 0 40px 0" }}>
                        <OverviewCarousel images={section.images} />
                      </div>
                    ) : section.imageSrc ? (
                      <div style={{ margin: "24px 0 40px 0" }}>
                        <div
      ...
      >
        ...
        >
          ...
          <div style={{ flex: "1 1 300px", minWidth: 280 }}>
            ...
            >
              Brand & Systems Thinking &middot; Design Leadership &middot; Visual & AI Strategy
            </p>
